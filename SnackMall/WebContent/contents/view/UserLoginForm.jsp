...
<body>
    ...
    <div id="wrap">
    	<b><font size="6" color="gray"> <i class="fas fa-sign-in-alt"></i>사용자 로그인</font></b>
        <br><br><br>
        <!-- 이미지 추가 -->
		<img src="../../img/welcome.jpg">
		<br><br>
        <form name="loginInfo" method="post" onsubmit="return checkValue()" action="../pro/UserLoginPro.jsp">
       		<table>
               <tr>
	               <td>아이디</td>
       	...
       	<input type="button" value="관리자로그인페이지" onclick="goAdminLoginForm()"> 
